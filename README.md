...
Open-source personality assessment. See yourself more clearly. "Tot suma, ningú no és imprescindible, però tots som necessaris."

## What is Cèrcol

Cèrcol is a personality assessment platform built on peer-reviewed, public-domain psychometric research. It gives individuals an honest, readable portrait of their personality across five dimensions, without jargon and without gatekeeping.
...
|---|---|
| **Presence** | How much energy you bring into a room. Whether people notice when you arrive. |
| **Bond** | How you hold relationships. The warmth, trust, and care you extend to others. |
| **Discipline** | How you organise yourself toward goals. Structure, follow-through, and reliability. |
| **Depth** | How intensely you feel things. The emotional range you carry. |
| **Vision** | How openly you engage with ideas, aesthetics, and new ways of seeing. |

No score is good or bad. Each reflects a tendency. Both ends of every dimension are valid and functional.

## Scientific foundation

All items come from the International Personality Item Pool (IPIP), a public-domain collection of personality items with no restrictions on commercial or non-commercial use. Items were selected by highest confirmatory factor loadings from published validation studies.
