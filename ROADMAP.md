...
| 17.6.7 | Backlog (planned): weekly digest email via Resend, públic subdomini `mcp.cercol.team` si l'ús ho justifica, GSC Crawl Stats ingest, CrUX BigQuery export. | |
