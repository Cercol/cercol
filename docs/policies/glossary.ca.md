# Translation glossary: ca

GENERATED FILE. Do not edit by hand: run `python3 scripts/build_glossary.py`.
The source of truth is `src/locales/ca.json`, the same file the running
...
| English | ca |
|---|---|
| New Moon Cèrcol | Cèrcol de Lluna Nova |
| First Quarter Cèrcol | Cèrcol de Quart Creixent |
| Full Moon Cèrcol | Cèrcol de Lluna Plena |
| Last Quarter Cèrcol | Cèrcol de Quart Minvant |
| Witness Cèrcol | Cèrcol de Testimoni |
