# Translation glossary: da

GENERATED FILE. Do not edit by hand: run `python3 scripts/build_glossary.py`.
The source of truth is `src/locales/da.json`, the same file the running
...
| English | da |
|---|---|
| New Moon Cèrcol | Nymåne Cèrcol |
| First Quarter Cèrcol | Første Kvarter Cèrcol |
| Full Moon Cèrcol | Fuldmåne Cèrcol |
| Last Quarter Cèrcol | Sidste Kvarter Cèrcol |
| Witness Cèrcol | Vidne Cèrcol |
...
Tilknytning is a Cèrcol dimension, Agreeableness is the academic
factor it maps onto.
