# Translation glossary: de

GENERATED FILE. Do not edit by hand: run `python3 scripts/build_glossary.py`.
The source of truth is `src/locales/de.json`, the same file the running
...
| English | de |
|---|---|
| New Moon Cèrcol | Cèrcol des Neumondes |
| First Quarter Cèrcol | Cèrcol des Ersten Viertels |
| Full Moon Cèrcol | Cèrcol des Vollmondes |
| Last Quarter Cèrcol | Cèrcol des Letzten Viertels |
| Witness Cèrcol | Cèrcol des Zeugen |
...
Bindung is a Cèrcol dimension, Agreeableness is the academic
factor it maps onto.
