...
The source of truth is `src/locales/en.json`, the same file the running
...
| English | en |
|---|---|
| New Moon Cèrcol | New Moon Cèrcol |
| First Quarter Cèrcol | First Quarter Cèrcol |
| Full Moon Cèrcol | Full Moon Cèrcol |
| Last Quarter Cèrcol | Last Quarter Cèrcol |
| Witness Cèrcol | Witness Cèrcol |
...
Bond is a Cèrcol dimension, Agreeableness is the academic
factor it maps onto.
