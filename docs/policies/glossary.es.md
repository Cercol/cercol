# Translation glossary: es

GENERATED FILE. Do not edit by hand: run `python3 scripts/build_glossary.py`.
The source of truth is `src/locales/es.json`, the same file the running
...
| English | es |
|---|---|
| New Moon Cèrcol | Cèrcol de Luna Nueva |
| First Quarter Cèrcol | Cèrcol de Cuarto Creciente |
| Full Moon Cèrcol | Cèrcol de Luna Llena |
| Last Quarter Cèrcol | Cèrcol de Cuarto Menguante |
| Witness Cèrcol | Cèrcol de Testigo |
