  ...
  },
  {
    ...
    "tasks": [
      ...
      },
      {
        ...
        "action": {
          "type": "prompt",
          "text": "Replace the Full Moon item set with the canonical IPIP-NEO-120 from src/data/reference/ipip-neo-120.json.\n\nContext, established by audit on 2026-08-22: only 57 of our 120 items are Johnson's, and 21 of ours are not IPIP items at all (verified against the full 3,320-item alphabetical list at ipip.ori.org/AlphabeticalItemList.htm). Some are a real item with a word changed in a way that moves the construct: 'Seldom feel joyful' is 'Seldom feel blue' with depression swapped for cheerfulness.\n\nWhat to do:\n1. Map each of the 30 canonical facets onto Cercol's facet key (vigil, blaze, hollow, veil, surge, ... ). The facet order already matches; verify that rather than assuming it.\n2. Replace the four items of each facet with the canonical four, keeping Cercol's id numbering and the reverse flag from the source's keyed direction.\n3. Carry the other-language strings ONLY where the English item is unchanged. Where the English item is new, the other languages must be filled in later steps, not invented here. Leave them absent and make the loader fall back to English rather than shipping a wrong translation.\n4. Bump INSTRUMENT_VERSION and add a changelog entry in docs/policies/dataset-versions.md saying exactly what changed and why.\n5. Re-verify the facet-to-domain mapping and the scoring against the new set, and run the full test suite.\n\nOpen this as its own pull request and do not merge it. The operator reviews an instrument change."
        },
        "done": false
      },
      {
