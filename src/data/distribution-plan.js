    ...
    "tasks": [
      {
        ...
        "why": "El danés és la teua base científica més forta. Avisar-la és cortesia i pot obrir endós i porta als mitjans danesos. Fidelitat danesa verificada (Vedel ok): pots enviar. La carta afirma que els nostres ítems segueixen la seua versió validada; això s'ha de comprovar abans d'enviar-la, perquè ella és exactament la persona que ho notaria. Revisat el 22/08/2026: la carta original afirmava que els nostres ítems seguien la seua versió, i això és fals. La prova és que el danés tenia 22 dels 60 ítems compartits traduïts de dues maneres diferents, cosa que transcriure una llista publicada no pot produir.",
        "aud": [
          "A"
        ],
        "pay": [
        ...
        "action": {
          ...
          "body": "Dear Dr Vedel,\n\nI am Miquel Matoses, the developer of Cèrcol (https://cercol.team), a free, open-source team personality assessment built on the public-domain IPIP item pool, in six languages.\n\nI am writing about the Danish one, and I want to be precise about what it is, because a vaguer version of this email would have claimed more than I can support.\n\nCèrcol's Danish items are an independent translation of the public-domain English IPIP items. They follow the methodology and the item alterations you documented in Vedel, Gøtzsche-Astrup & Holm (2018), but they are not your instrument and are not derived from it. What your validation gives us is the reason we can interpret the Danish five-factor structure with any confidence at all, which is why Danish is the language I trust most in the project.\n\nA philologist review this week found around thirty strings worth correcting, and they are corrected. It has still not had a native-speaker read-through, so I would not describe it as validated and I have said so on our science page.\n\nIf you would ever be willing to look, your eye on it would be worth more than anything else we could do to it. And if not, this is simply a thank-you: your paper is the reason one of our six languages stands on something solid.\n\nThe items, the scoring and the limitations are all public: https://github.com/cercol/cercol/blob/main/SCIENCE.md\n\nKind regards,\nMiquel Matoses\ncercol.team"
        }
      },
      {
        "id": "t12",
        "title": "Escriure a Thiry & Piolti (adaptació francesa)",
        "why": "Mateixa lògica per al francés. Marc honest: segueixes la seua aproximació de traducció, no una validació en revista. Fidelitat francesa verificada i claim 'peer-reviewed' ja corregida (PR #83): pots enviar. Revisat el 22/08/2026: la carta original afirmava que els nostres ítems seguien la seua versió, i això és fals. La prova és que el danés tenia 22 dels 60 ítems compartits traduïts de dues maneres diferents, cosa que transcriure una llista publicada no pot produir.",
        "aud": [
          "A"
        ],
        "pay": [
        ...
        "action": {
          ...
          "body": "Bonjour Monsieur Thiry, bonjour Madame Piolti,\n\nJe suis Miquel Matoses, développeur de Cèrcol (https://cercol.team), un test de personnalité d'équipe libre et open source fondé sur le pool d'items IPIP, qui est dans le domaine public.\n\nJe vous écris au sujet des items français, et je tiens à être précis sur ce qu'ils sont, car une version plus vague de ce message affirmerait davantage que ce que je peux soutenir.\n\nLes items français de Cèrcol sont une traduction directe et indépendante des items anglais du domaine public. Ils suivent les principes de français européen que vous avez documentés en 2023, mais ils ne dérivent pas de votre adaptation et n'ont pas eu la relecture par des locuteurs natifs qui caractérise votre travail. Votre adaptation est notre point de référence, pas notre source.\n\nUne relecture philologique cette semaine a relevé une soixantaine de chaînes à corriger, dont deux formes conjuguées à la troisième personne. Elles sont corrigées. Il manque encore une lecture complète par un locuteur natif, et je ne parlerai pas de validation avant.\n\nSi l'un de vous avait un jour l'envie d'y jeter un œil, vos retours seraient les bienvenus. Sinon, considérez ceci comme un remerciement : votre travail est ce qui nous a donné une référence en français européen plutôt qu'un simple calque.\n\nLe calcul, les items et les limites connues sont publics : https://github.com/cercol/cercol/blob/main/SCIENCE.md\n\nCordialement,\nMiquel Matoses\ncercol.team"
        }
      },
      {
        "id": "t21",
