...
export const FQ_ITEMS = [
  ...
  // Vigil (Anxiety)
  { id: 1,  text: { en: 'Worry about things.', ca: 'Em preocupo per les coses.', es: 'Me preocupo por las cosas.', fr: 'Me préoccupe des choses.', de: 'Mache mir Sorgen um Dinge.', da: 'Bekymrer mig over tingene.' },
  ...
  { id: 4,  text: { en: 'Get irritated easily.', ca: "M'irrito amb facilitat.", es: 'Me irrito con facilidad.', fr: "M'irrite facilement.", de: 'Werde leicht gereizt.', da: 'Bliver let irriteret.' },
    domain: 'depth', facet: 'blaze', reverse: false },
  ...
  { id: 7,  text: { en: 'Am easily embarrassed.', ca: "M'avergonyeixo amb facilitat.", es: 'Me avergüenzo con facilidad.', fr: 'Suis facilement embarrassé·e.', de: 'Bin leicht verlegen.', da: 'Bliver let flov.' },
  ...
  { id: 12, text: { en: "Feel that I'm unable to deal with things.", ca: 'Sento que soc incapaç de fer front a les coses.', es: 'Siento que soy incapaz de hacer frente a las cosas.', fr: 'Sens que je suis incapable de faire face aux choses.', de: 'Fühle mich unfähig, mit den Dingen umzugehen.', da: 'Føler, at jeg ikke kan håndtere tingene.' },
    domain: 'depth', facet: 'fracture', reverse: false },
  ...
  { id: 22, text: { en: 'Prefer quiet, peaceful settings.', ca: 'Prefereixo entorns tranquils i pacífics.', es: 'Prefiero entornos tranquilos y pacíficos.', fr: 'Préfère les environnements calmes et paisibles.', de: 'Bevorzuge ruhige, friedliche Umgebungen.', da: 'Foretrækker rolige og fredelige omgivelser.' },
  ...
  { id: 24, text: { en: 'Am not easily amused.', ca: 'No em diverteixo amb facilitat.', es: 'No me divierto con facilidad.', fr: "Ne m'amuse pas facilement.", de: 'Bin nicht leicht zu amüsieren.', da: 'Er ikke let at more.' },
  ...
  { id: 38, text: { en: 'Suspect hidden motives in others.', ca: 'Sospito de les motivacions ocultes dels altres.', es: 'Sospecho de las motivaciones ocultas de los demás.', fr: 'Suspecte des motifs cachés chez les autres.', de: 'Vermute verborgene Motive bei anderen.', da: 'Mistænker skjulte motiver hos andre.' },
  ...
  { id: 40, text: { en: 'Use flattery to get ahead.', ca: "Faig servir l'adulació per progressar.", es: 'Uso la adulación para progresar.', fr: 'Utilise la flatterie pour progresser.', de: 'Nutze Schmeichelei, um voranzukommen.', da: 'Bruger smiger til at komme videre.' },
    domain: 'bond', facet: 'edge', reverse: true },

  // Gift (Altruism)
  { id: 41, text: { en: 'Make people feel welcome.', ca: 'Faig que la gent se senti benvinguda.', es: 'Hago que la gente se sienta bienvenida.', fr: 'Fais sentir les gens bienvenus.', de: 'Lasse Menschen sich willkommen fühlen.', da: 'Får folk til at føle sig velkomne.' },
  ...
  { id: 47, text: { en: 'Sympathize with the homeless.', ca: 'Em compadeixo de les persones sense llar.', es: 'Me compadezco de las personas sin hogar.', fr: 'Compatit avec les sans-abri.', de: 'Sympathisiere mit Obdachlosen.', da: 'Har medfølelse med hjemløse.' },
  ...
  { id: 52, text: { en: 'Leave a mess in my room.', ca: 'Deixo la meva habitació desordenada.', es: 'Dejo mi habitación desordenada.', fr: 'Laisse du désordre dans ma chambre.', de: 'Hinterlasse Unordnung in meinem Zimmer.', da: 'Efterlader rod i mit værelse.' },
  ...
  { id: 56, text: { en: 'Put little time and effort into my work.', ca: 'Dedico poc temps i esforç al meu treball.', es: 'Dedico poco tiempo y esfuerzo a mi trabajo.', fr: "Consacre peu de temps et d'efforts à mon travail.", de: 'Investiere wenig Zeit und Mühe in meine Arbeit.', da: 'Bruger lidt tid og kræfter på mit arbejde.' },
    domain: 'discipline', facet: 'quest', reverse: true },

  // Will (Self-Discipline)
  { id: 57, text: { en: 'Get started on things right away.', ca: 'Em poso a fer les coses de seguida.', es: 'Empiezo las cosas de inmediato.', fr: 'Me lance dans les choses tout de suite.', de: 'Fange sofort mit Dingen an.', da: 'Går i gang med tingene med det samme.' },
