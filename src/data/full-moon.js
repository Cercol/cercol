...
export const FM_ITEMS = [
  ...
  { id: 20, text: { en: 'Rarely overindulge.',              ca: 'Rarament em passo de la ratlla.',              es: 'Rara vez me excedo.',                             fr: 'Me laisse rarement aller à l\'excès.', de: 'Übertreibe selten.',                    da: 'Overdriver sjældent.' }, domain: 'depth', facet: 'surge',   reverse: true  },
  ...
  { id: 24, text: { en: 'Remain calm under pressure.',      ca: 'Em mantinc tranquil/il·la sota pressió.',      es: 'Me mantengo tranquilo/a bajo presión.',            fr: 'Reste calme sous pression.',           de: 'Bleibe unter Druck ruhig.',             da: 'Forbliver rolig under pres.' }, domain: 'depth', facet: 'fracture', reverse: true  },
  ...
  { id: 46, text: { en: 'Am not easily amused.',            ca: 'No em diverteixo amb facilitat.',            es: 'No me divierto con facilidad.',                   fr: 'Ne m\'amuse pas facilement.',          de: 'Bin nicht leicht zu unterhalten.',      da: 'Bliver ikke let underholdt.' }, domain: 'presence', facet: 'radiance', reverse: true  },
  { id: 47, text: { en: 'Have a lot of fun.',               ca: "M'ho passo molt bé.",               es: 'Me divierto mucho.',                              fr: 'M\'amuse beaucoup.',                   de: 'Habe sehr viel Spaß.',                  da: 'Har det sjovt.' }, domain: 'presence', facet: 'radiance', reverse: false },
  ...
  { id: 55, text: { en: 'See beauty in things that others might not notice.', ca: 'Veig bellesa en coses que els altres potser no adverteixen.', es: 'Veo belleza en cosas que otros quizás no notan.', fr: 'Vois de la beauté dans des choses que les autres pourraient ne pas remarquer.', de: 'Sehe Schönheit in Dingen, die andere vielleicht nicht bemerken.',  da: 'Ser skønhed i ting, som andre måske ikke lægger mærke til.' }, domain: 'vision', facet: 'craft', reverse: false },
  ...
  { id: 72, text: { en: 'Believe in one true religion.',    ca: 'Crec en una sola religió veritable.',    es: 'Creo en una sola religión verdadera.',            fr: 'Crois en une seule vraie religion.',   de: 'Glaube an eine einzige wahre Religion.', da: 'Tror på én sand religion.' }, domain: 'vision', facet: 'compass',   reverse: true  },
  ...
  { id: 76, text: { en: 'Distrust people.',                 ca: 'Desconfio de la gent.',                 es: 'Desconfío de las personas.',                      fr: 'Me méfie des gens.',                   de: 'Misstraue Menschen.',                   da: 'Mistror folk.' }, domain: 'bond', facet: 'faith',     reverse: true  },
  ...
  { id: 84, text: { en: 'Look down on others.',             ca: "Miro els altres per damunt de l'espatlla.",             es: 'Menosprecio a los demás.',                        fr: 'Méprise les autres.',                  de: 'Schaue auf andere herab.',              da: 'Ser ned på andre.' }, domain: 'bond', facet: 'gift',      reverse: true  },

  // Yield (Compliance)
  { id: 85, text: { en: 'Hate to seem pushy.',              ca: 'Detesto semblar insistent.',              es: 'Me disgusta parecer insistente.',                 fr: 'Déteste paraître insistant·e.',        de: 'Mag es nicht, aufdringlich zu wirken.',  da: 'Kan ikke lide at virke påtrængende.' }, domain: 'bond', facet: 'yield',     reverse: false },
  ...
  { id: 92, text: { en: 'Boast about my virtues.',          ca: 'Presumeixo de les meves virtuts.',          es: 'Me jacto de mis virtudes.',                       fr: 'Me vante de mes vertus.',              de: 'Prahle mit meinen Vorzügen.',           da: 'Praler med mine dyder.' }, domain: 'bond', facet: 'shadow',    reverse: true  },
  ...
  { id: 95, text: { en: "Suffer from others' sorrows.",     ca: 'Pateixo amb les penes dels altres.',     es: 'Sufro con las penas de los demás.',               fr: 'Souffre des peines des autres.',       de: 'Leide unter dem Kummer anderer.',       da: 'Lider af andres sorg.' }, domain: 'bond', facet: 'shield',    reverse: false },
  ...
  { id: 98,  text: { en: 'Misjudge situations.',            ca: 'Jutjo malament les situacions.',             es: 'Evalúo mal las situaciones.',                     fr: 'Juge mal les situations.',             de: 'Beurteile Situationen falsch.',         da: 'Misforstår situationer.' }, domain: 'discipline', facet: 'mastery',   reverse: true  },
  ...
  { id: 104, text: { en: 'Fail to put things back in their proper place.', ca: 'No poso les coses al seu lloc.', es: 'No pongo las cosas en su sitio.', fr: 'Ne remet pas les choses à leur place.', de: 'Lege Dinge nicht an ihren richtigen Platz zurück.',  da: 'Glemmer at lægge ting tilbage på deres rette plads.' }, domain: 'discipline', facet: 'structure', reverse: true },
  ...
  { id: 113, text: { en: 'Get started on things right away.', ca: 'Em poso a fer les coses de seguida.', es: 'Empiezo las cosas de inmediato.',                fr: 'Me lance dans les choses tout de suite.', de: 'Fange Dinge sofort an.',                da: 'Går i gang med tingene med det samme.' }, domain: 'discipline', facet: 'will',   reverse: false },
  ...
  { id: 115, text: { en: 'Get to work at once.',            ca: 'Em poso a treballar de seguida.',             es: 'Me pongo a trabajar de inmediato.',                fr: 'Me mets au travail immédiatement.',    de: 'Fange sofort mit der Arbeit an.',       da: 'Sætter mig i gang med arbejdet med det samme.' }, domain: 'discipline', facet: 'will',      reverse: false },
  ...
  { id: 117, text: { en: 'Think before I speak.',           ca: 'Penso abans de parlar.',            es: 'Pienso antes de hablar.',                          fr: 'Réfléchis avant de parler.',           de: 'Denke nach, bevor ich spreche.',        da: 'Tænker, inden jeg taler.' }, domain: 'discipline', facet: 'counsel',   reverse: false },
  ...
  { id: 120, text: { en: 'Rush into things.',               ca: 'Em llanço a les coses de cap.',                es: 'Me lanzo a las cosas sin pensar.',                 fr: 'Me précipite dans les choses.',        de: 'Stürze mich kopflos in Dinge.',         da: 'Kaster mig ud i tingene uden at tænke.' }, domain: 'discipline', facet: 'counsel',   reverse: true  },
]
