...
export const FM_ITEMS = [
  ...
  { id: 4,   text: { en: 'Get stressed out easily.', de: 'Bin schnell gestresst.', ca: "M'estresso amb facilitat.", 'es-MX': 'Me estreso fácilmente.', 'fr-CA': 'Je deviens stressé facilement.', 'fr-FR': 'Je deviens stressé·e facilement.', da: 'Bliver let stresset.' }, domain: 'depth', facet: 'vigil', reverse: false },
  // Blaze (Anger) — n2
  ...
  { id: 15,  text: { en: 'Only feel comfortable with friends.', de: 'Fühle mich nur mit Freunden wohl.', ca: 'Només em sento còmode/a amb els amics.', 'es-MX': 'Solo me siento cómodo con mis amigos.', 'fr-CA': "Je me sens seulement à l'aise avec mes amis.", 'fr-FR': "Je ne me sens à l'aise qu'avec mes amis.", da: 'Har det kun rart med mine venner.' }, domain: 'depth', facet: 'veil', reverse: false },
  { id: 16,  text: { en: 'Am not bothered by difficult social situations.', de: 'Habe kein Problem mit schwierigen sozialen Situationen.', ca: 'No em molesten les situacions socials difícils.', 'es-MX': 'No me molestan las situaciones sociales difíciles.', 'fr-CA': 'Je ne suis pas dérangé par les situations sociales difficiles.', 'fr-FR': 'Je ne suis pas dérangé·e par les situations sociales difficiles.', da: 'Har ikke noget imod komplekse sociale situationer.' }, domain: 'depth', facet: 'veil', reverse: true  },
  // Surge (Immoderation) — n5
  { id: 17,  text: { en: 'Go on binges.', de: 'Schlage über die Stränge.', ca: 'Faig excessos.', 'es-MX': 'Tiendo a excederme.', 'fr-CA': 'Je fais des excès.', da: 'Går amok med mad og drikke.' }, domain: 'depth', facet: 'surge', reverse: false },
  { id: 18,  text: { en: 'Easily resist temptations.', de: 'Widerstehe Versuchungen leicht.', ca: 'Resisteixo les temptacions amb facilitat.', 'es-MX': 'Resisto sin dificultad a las tentaciones.', 'fr-CA': 'Je résiste facilement à la tentation.', da: 'Har let ved at modstå fristelser.' }, domain: 'depth', facet: 'surge', reverse: true  },
  ...
  { id: 20,  text: { en: 'Am able to control my cravings.', de: 'Kann meine Gelüste kontrollieren.', ca: 'Soc capaç de controlar les meves ganes.', 'es-MX': 'Soy capaz de controlar mis antojos.', 'fr-CA': 'Je suis capable de contrôler mes envies.', da: 'Kan styre mine behov.' }, domain: 'depth', facet: 'surge', reverse: true  },
  ...
  { id: 23,  text: { en: "Feel that I'm unable to deal with things.", ca: 'Sento que soc incapaç de fer front a les coses.', 'es-MX': 'Creo que soy incapaz de lidiar con cosas.', 'fr-CA': 'Je me sens incapable de gérer les choses.', de: 'Habe das Gefühl, dass ich mit Dingen nicht umgehen kann.', da: 'Føler, at jeg har svært ved at håndtere mange ting.' }, domain: 'depth', facet: 'fracture', reverse: false },
  ...
  { id: 26,  text: { en: 'Feel comfortable around people.', de: 'Fühle mich unter Menschen wohl.', ca: 'Em sento còmode/a amb la gent.', 'es-MX': 'Me siento cómodo entre personas.', 'fr-CA': 'Je me sens confortable avec les gens.', 'fr-FR': "Je me sens à l'aise avec les gens.", da: 'Har det godt sammen med andre.' }, domain: 'presence', facet: 'hearth', reverse: false },
  { id: 27,  text: { en: 'Avoid contacts with others.', de: 'Vermeide den Kontakt zu anderen.', ca: 'Evito el contacte amb els altres.', 'es-MX': 'Evito tener contacto con otros.', 'fr-CA': "J'évite le contact avec les autres.", da: 'Undgår kontakt med andre.' }, domain: 'presence', facet: 'hearth', reverse: true  },
  { id: 28,  text: { en: 'Keep others at a distance.', de: 'Halte andere auf Abstand.', ca: 'Mantinc els altres a distància.', 'es-MX': 'Mantengo a los demás a distancia.', 'fr-CA': 'Je garde les autres à distance.', da: 'Holder andre på afstand.' }, domain: 'presence', facet: 'hearth', reverse: true  },
  // Gather (Gregariousness) — e2
  { id: 29,  text: { en: 'Love large parties.', de: 'Liebe große Partys.', ca: "M'encanten les festes amb molta gent.", 'es-MX': 'Me encantan las fiestas grandes.', 'fr-CA': "J'adore les grandes fêtes.", da: 'Elsker store fester.' }, domain: 'presence', facet: 'gather', reverse: false },
  { id: 30,  text: { en: 'Talk to a lot of different people at parties.', de: 'Spreche auf Partys mit vielen verschiedenen Menschen.', ca: 'A les festes parlo amb molta gent diferent.', 'es-MX': 'En las reuniones hablo con muchas personas distintas.', 'fr-CA': 'Je parle à plusieurs personnes dans les partys.', 'fr-FR': 'Je parle à beaucoup de personnes différentes lors des fêtes.', da: 'Taler med mange forskellige mennesker til fester.' }, domain: 'presence', facet: 'gather', reverse: false },
  ...
  { id: 32,  text: { en: 'Avoid crowds.', de: 'Vermeide Menschenmengen.', ca: 'Evito les multituds.', 'es-MX': 'Evito las multitudes.', 'fr-CA': "J'évite les foules.", da: 'Undgår folkemængder.' }, domain: 'presence', facet: 'gather', reverse: true  },
  ...
  { id: 35,  text: { en: 'Take control of things.', de: 'Nehme die Dinge in die Hand.', ca: 'Prenc el control de les coses.', 'es-MX': 'Tomo el control de las cosas.', 'fr-CA': 'Je prends le contrôle des choses.', da: 'Tager kontrollen.' }, domain: 'presence', facet: 'command', reverse: false },
  ...
  { id: 38,  text: { en: 'Am always on the go.', ca: 'Sempre estic en moviment.', 'es-MX': 'Siempre estoy activo.', 'fr-CA': 'Je suis toujours en mouvement.', de: 'Bin immer unterwegs.', da: 'Er altid i gang med noget.' }, domain: 'presence', facet: 'drive', reverse: false },
  { id: 39,  text: { en: 'Do a lot in my spare time.', de: 'Unternehme viel in meiner Freizeit.', ca: 'Faig moltes coses en el meu temps lliure.', 'es-MX': 'Hago muchas cosas en mi tiempo libre.', 'fr-CA': 'Je fais beaucoup de choses dans mes temps libres.', 'fr-FR': 'Je fais beaucoup de choses pendant mon temps libre.', da: 'Laver en masse i min fritid.' }, domain: 'presence', facet: 'drive', reverse: false },
  { id: 40,  text: { en: 'Like to take it easy.', ca: "M'agrada prendre-m'ho amb calma.", 'es-MX': 'Me gusta tomar las cosas con calma.', 'fr-CA': "J'aime prendre ça mollo.", 'fr-FR': "J'aime prendre les choses tranquillement.", de: 'Lasse es gerne ruhig angehen.', da: 'Kan godt lide at slappe af.' }, domain: 'presence', facet: 'drive', reverse: true  },
  ...
  { id: 43,  text: { en: 'Enjoy being reckless.', de: 'Bin gerne waghalsig.', ca: "M'agrada ser imprudent.", 'es-MX': 'Disfruto ser imprudente.', 'fr-CA': "J'agis de manière effrénée.", da: 'Nyder at tage vilde chancer.' }, domain: 'presence', facet: 'thrill', reverse: false },
  { id: 44,  text: { en: 'Act wild and crazy.', de: 'Verhalte mich wild und verrückt.', ca: 'Faig bogeries.', 'es-MX': 'Me comporto de manera desenfrenada y descontrolada.', 'fr-CA': "J'agis de façon téméraire.", da: 'Opfører mig vildt.' }, domain: 'presence', facet: 'thrill', reverse: false },
  ...
  { id: 47,  text: { en: 'Love life.', de: 'Liebe das Leben.', ca: "M'encanta la vida.", 'es-MX': 'Amo la vida.', 'fr-CA': "J'adore la vie.", da: 'Elsker livet.' }, domain: 'presence', facet: 'radiance', reverse: false },
  { id: 48,  text: { en: 'Look at the bright side of life.', de: 'Sehe das Leben von der schönen Seite.', ca: 'Miro el costat bo de la vida.', 'es-MX': 'Veo el lado positivo de la vida.', 'fr-CA': 'Je regarde le bon côté de la vie.', da: 'Fokuserer på de positive ting i tilværelsen.' }, domain: 'presence', facet: 'radiance', reverse: false },
  ...
  { id: 50,  text: { en: 'Enjoy wild flights of fantasy.', de: 'Lasse meiner Fantasie gerne freien Lauf.', ca: "M'agrada deixar volar la imaginació.", 'es-MX': 'Disfruto fantasear.', 'fr-CA': "J'aime me perdre dans mes idées.", da: 'Nyder at fortabe mig i vilde fantasier.' }, domain: 'vision', facet: 'dream', reverse: false },
  { id: 51,  text: { en: 'Love to daydream.', de: 'Liebe es, vor mich hin zu träumen.', ca: "M'encanta somiar despert/a.", 'es-MX': 'Me gusta soñar despierto.', 'fr-CA': "J'adore rêvasser.", da: 'Elsker at dagdrømme.' }, domain: 'vision', facet: 'dream', reverse: false },
  { id: 52,  text: { en: 'Like to get lost in thought.', de: 'Versinke gerne in Gedanken.', ca: "M'agrada perdre'm en els meus pensaments.", 'es-MX': 'Me gusta perderme en mis pensamientos.', 'fr-CA': "J'aime me perdre dans mes pensées.", da: 'Kan godt lide at fortabe mig i mine tanker.' }, domain: 'vision', facet: 'dream', reverse: false },
  ...
  { id: 55,  text: { en: 'Do not like poetry.', de: 'Mag Gedichte nicht.', ca: "No m'agrada la poesia.", 'es-MX': 'No me gusta la poesía.', 'fr-CA': "Je n'aime pas la poésie.", da: 'Bryder mig ikke om poesi.' }, domain: 'vision', facet: 'craft', reverse: true  },
  { id: 56,  text: { en: 'Do not enjoy going to art museums.', de: 'Gehe nicht gerne in Kunstmuseen.', ca: "No m'agrada anar a museus d'art.", 'es-MX': 'No disfruto ir a museos de arte.', 'fr-CA': "Je n'apprécie pas aller à des musées d'art.", 'fr-FR': "Je n'apprécie pas d'aller dans des musées d'art.", da: 'Bryder mig ikke om at gå på kunstmuseer.' }, domain: 'vision', facet: 'craft', reverse: true  },
  ...
  { id: 58,  text: { en: "Feel others' emotions.", 'es-MX': 'Siento las emociones de los demás.', de: 'Spüre die Gefühle anderer.', ca: 'Sento les emocions dels altres.', 'fr-CA': 'Je ressens les émotions des autres.', da: 'Fornemmer andres følelser.' }, domain: 'vision', facet: 'resonance', reverse: false },
  ...
  { id: 60,  text: { en: "Don't understand people who get emotional.", ca: "No entenc les persones que s'emocionen.", 'es-MX': 'No comprendo a la gente que se pone muy emocional.', 'fr-CA': 'Je ne comprends pas les gens émotifs.', de: 'Verstehe Menschen nicht, die emotional werden.', da: 'Forstår ikke dem, der bliver følelsesladede.' }, domain: 'vision', facet: 'resonance', reverse: true  },
  ...
  { id: 63,  text: { en: 'Dislike changes.', de: 'Mag Veränderungen nicht.', ca: "No m'agraden els canvis.", 'es-MX': 'No me agradan los cambios.', 'fr-CA': "Je n'aime pas les changements.", da: 'Bryder mig ikke om forandringer.' }, domain: 'vision', facet: 'drift', reverse: true  },
  { id: 64,  text: { en: 'Am attached to conventional ways.', de: 'Hänge am Althergebrachten.', ca: 'Estic aferrat/da a les maneres de fer convencionals.', 'es-MX': 'Soy apegado a las formas convencionales.', 'fr-CA': 'Je suis attaché aux méthodes conventionnelles.', 'fr-FR': 'Je suis attaché·e aux méthodes conventionnelles.', da: 'Holder mig til traditionerne.' }, domain: 'vision', facet: 'drift', reverse: true  },
  // Prism (Intellect) — o5
  { id: 65,  text: { en: 'Love to read challenging material.', de: 'Liebe es, anspruchsvolle Texte zu lesen.', ca: "M'encanta llegir textos exigents.", 'es-MX': 'Me encanta leer temas desafiantes.', 'fr-CA': "J'adore lire des documents stimulants.", da: 'Elsker at læse svære tekster.' }, domain: 'vision', facet: 'prism', reverse: false },
  ...
  { id: 68,  text: { en: 'Am not interested in theoretical discussions.', de: 'Interessiere mich nicht für theoretische Diskussionen.', ca: "No m'interessen les discussions teòriques.", 'es-MX': 'No tengo interés en las discusiones teóricas o hipotéticas.', 'fr-CA': 'Je ne suis pas intéressé par les discussions théoriques.', 'fr-FR': 'Je ne suis pas intéressé·e par les discussions théoriques.', da: 'Er ikke interesseret i teoretiske diskussioner.' }, domain: 'vision', facet: 'prism', reverse: true  },
  // Compass (Liberalism) — o6
  { id: 69,  text: { en: 'Tend to vote for liberal political candidates.', de: 'Neige dazu, für progressive politische Kandidat*innen zu stimmen.', ca: 'Solc votar candidatures polítiques progressistes.', 'es-MX': 'Tiendo a votar por políticos liberales.', 'fr-CA': 'J’ai tendance à promouvoir des valeurs sociales libérales.', 'fr-FR': "J'ai tendance à promouvoir des valeurs sociales progressistes.", da: 'Ser mig selv som mest venstreorienteret.' }, domain: 'vision', facet: 'compass', reverse: false },
  { id: 70,  text: { en: 'Believe that there is no absolute right and wrong.', de: 'Glaube, dass es kein absolutes Richtig und Falsch gibt.', ca: 'Crec que no hi ha un bé i un mal absoluts.', 'es-MX': 'Creo que no existe el mal o el bien absoluto.', 'fr-CA': "Je crois qu'il n'y a pas de bon ou de mauvais absolu.", da: 'Mener ikke, der er noget absolut rigtigt eller forkert.' }, domain: 'vision', facet: 'compass', reverse: false },
  { id: 71,  text: { en: 'Tend to vote for conservative political candidates.', ca: 'Solc votar candidatures polítiques conservadores.', 'es-MX': 'Tiendo a votar por candidatos políticos conservadores.', 'fr-CA': 'J’ai tendance à promouvoir des valeurs sociales traditionnelles.', de: 'Neige dazu, für konservative politische Kandidat*innen zu stimmen.', da: 'Ser mig selv som mest højreorienteret.' }, domain: 'vision', facet: 'compass', reverse: true  },
  { id: 72,  text: { en: 'Believe that we should be tough on crime.', de: 'Glaube, dass wir hart gegen Kriminalität vorgehen sollten.', ca: 'Crec que hem de ser durs amb la delinqüència.', 'es-MX': 'Creo que se debe de ser fuertes contra el crimen.', 'fr-CA': 'Je crois que nous devrions être sévères à propos des crimes.', da: 'Synes, vi skal slå hårdt ned på kriminalitet.' }, domain: 'vision', facet: 'compass', reverse: true  },
  ...
  { id: 75,  text: { en: 'Trust what people say.', de: 'Vertraue dem, was andere sagen.', ca: 'Confio en el que diu la gent.', 'es-MX': 'Confío en lo que la gente dice.', 'fr-CA': "J'ai confiance en ce que les gens disent.", da: 'Stoler på, hvad andre siger.' }, domain: 'bond', facet: 'faith', reverse: false },
  ...
  // Edge (Morality) — a2
  { id: 77,  text: { en: 'Use others for my own ends.', de: 'Benutze andere für meine eigenen Zwecke.', ca: 'Utilitzo els altres en benefici propi.', 'es-MX': 'Uso a otros para mi propio interés.', 'fr-CA': "J'utilise les autres pour mes propres fins.", da: 'Bruger andre til at opnå mine egne mål.' }, domain: 'bond', facet: 'edge', reverse: true  },
  { id: 78,  text: { en: 'Cheat to get ahead.', de: 'Betrüge, um weiterzukommen.', ca: 'Faig trampes per arribar més lluny.', 'es-MX': 'Hago trampa para avanzar.', 'fr-CA': 'Je triche pour avancer.', da: 'Snyder for at få et forspring.' }, domain: 'bond', facet: 'edge', reverse: true  },
  ...
  { id: 80,  text: { en: "Obstruct others' plans.", de: 'Durchkreuze die Pläne anderer.', ca: 'Entorpeixo els plans dels altres.', 'es-MX': 'Obstaculizo los planes de otros.', 'fr-CA': "J'entrave les plans des autres.", da: 'Stiller hindringer i vejen for andre.' }, domain: 'bond', facet: 'edge', reverse: true  },
  // Gift (Altruism) — a3
  { id: 81,  text: { en: 'Am concerned about others.', de: 'Kümmere mich um andere.', ca: 'Em preocupo pels altres.', 'es-MX': 'Me preocupo por los demás.', 'fr-CA': 'Je me préoccupe des autres.', da: 'Bekymrer mig om andre.' }, domain: 'bond', facet: 'gift', reverse: false },
  { id: 82,  text: { en: 'Love to help others.', de: 'Liebe es, anderen zu helfen.', ca: "M'encanta ajudar els altres.", 'es-MX': 'Me gusta ayudar a otros.', 'fr-CA': "J'adore aider les autres.", da: 'Elsker at hjælpe andre.' }, domain: 'bond', facet: 'gift', reverse: false },
  ...
  { id: 84,  text: { en: 'Take no time for others.', de: 'Nehme mir keine Zeit für andere.', ca: 'No dedico temps als altres.', 'es-MX': 'No tengo tiempo para lo demás.', 'fr-CA': 'Je ne prends pas de temps pour les autres.', da: 'Bruger ikke tid på andres problemer.' }, domain: 'bond', facet: 'gift', reverse: true  },
  // Yield (Cooperation) — a4
  { id: 85,  text: { en: 'Love a good fight.', de: 'Liebe einen ordentlichen Streit.', ca: "M'encanta una bona baralla.", 'es-MX': 'Me gusta una buena confrontación.', 'fr-CA': "J'adore une bonne bagarre.", da: 'Elsker en god fight.' }, domain: 'bond', facet: 'yield', reverse: true  },
  { id: 86,  text: { en: 'Yell at people.', de: 'Schreie Menschen an.', ca: 'Escridasso les persones.', 'es-MX': 'Grito a la gente.', 'fr-CA': 'Je crie après les gens.', da: 'Råber ad folk.' }, domain: 'bond', facet: 'yield', reverse: true  },
  ...
  { id: 88,  text: { en: 'Get back at others.', de: 'Zahle es anderen heim.', ca: 'Em venjo dels altres.', 'es-MX': 'Cuando me la hacen me la pagan.', 'fr-CA': "Je m'en prends aux autres.", da: 'Tager hævn over andre.' }, domain: 'bond', facet: 'yield', reverse: true  },
  // Shadow (Modesty) — a5
  { id: 89,  text: { en: 'Believe that I am better than others.', de: 'Glaube, dass ich besser bin als andere.', ca: 'Crec que soc millor que els altres.', 'es-MX': 'Creo que soy mejor que otros.', 'fr-CA': 'Je crois être meilleur que les autres.', 'fr-FR': 'Je crois être meilleur·e que les autres.', da: 'Mener, jeg er bedre end andre.' }, domain: 'bond', facet: 'shadow', reverse: true  },
  ...
  { id: 91,  text: { en: 'Have a high opinion of myself.', de: 'Halte viel von mir selbst.', ca: 'Tinc molt bona opinió de mi mateix/a.', 'es-MX': 'Tengo una opinión alta de mí mismo.', 'fr-CA': "J'ai une très bonne opinion de moi-même.", da: 'Er meget glad for mig selv.' }, domain: 'bond', facet: 'shadow', reverse: true  },
  ...
  { id: 94,  text: { en: 'Feel sympathy for those who are worse off than myself.', de: 'Habe Mitgefühl mit Menschen, denen es schlechter geht als mir.', ca: 'Em compadeixo dels qui estan pitjor que jo.', 'es-MX': 'Siento empatía por aquellos que están más necesitados que yo.', 'fr-CA': "J'ai de la sympathie pour les gens plus démunis que moi.", da: 'Føler sympati for dem, der har det værre end mig selv.' }, domain: 'bond', facet: 'shield', reverse: false },
  ...
  { id: 96,  text: { en: 'Try not to think about the needy.', de: 'Versuche, nicht an Bedürftige zu denken.', ca: 'Intento no pensar en la gent necessitada.', 'es-MX': 'Intento no pensar en las personas necesitadas.', 'fr-CA': 'Je tente de ne pas penser aux gens dans le besoin.', da: 'Forsøger at lade være med at tænke på de fattige.' }, domain: 'bond', facet: 'shield', reverse: true  },

  // ── DISCIPLINE (Conscientiousness) ──────────────
  // Mastery (Self-Efficacy) — c1
  { id: 97,  text: { en: 'Complete tasks successfully.', de: 'Erledige Aufgaben erfolgreich.', ca: 'Completo les tasques amb èxit.', 'es-MX': 'Completo tareas exitosamente.', 'fr-CA': 'Je complète les tâches avec succès.', 'fr-FR': "J'accomplis les tâches avec succès.", da: 'Fuldfører opgaver med succes.' }, domain: 'discipline', facet: 'mastery', reverse: false },
  { id: 98,  text: { en: 'Excel in what I do.', de: 'Bin hervorragend in dem, was ich tue.', ca: 'Destaco en el que faig.', 'es-MX': 'Sobresalgo en lo que hago.', 'fr-CA': "J'excelle dans ce que je fais.", da: 'Udmærker mig i de ting, jeg laver.' }, domain: 'discipline', facet: 'mastery', reverse: false },
  { id: 99,  text: { en: 'Handle tasks smoothly.', de: 'Bewältige Aufgaben mühelos.', ca: 'Faig les tasques sense entrebancs.', 'es-MX': 'Realizo las tareas sin problemas.', 'fr-CA': 'Je gère les tâches facilement.', da: 'Håndterer opgaver med lethed.' }, domain: 'discipline', facet: 'mastery', reverse: false },
  { id: 100, text: { en: 'Know how to get things done.', de: 'Weiß, wie man Dinge erledigt.', ca: 'Sé com treure la feina endavant.', 'es-MX': 'Se cómo hacer las cosas.', 'fr-CA': 'Je sais comment faire avancer les choses.', da: 'Ved, hvordan man får tingene gjort.' }, domain: 'discipline', facet: 'mastery', reverse: false },
  // Structure (Orderliness) — c2
  { id: 101, text: { en: 'Like to tidy up.', de: 'Räume gerne auf.', ca: "M'agrada endreçar.", 'es-MX': 'Me gusta ordenar y organizar las cosas.', 'fr-CA': "J'aime faire du rangement.", da: 'Kan godt lide at rydde op.' }, domain: 'discipline', facet: 'structure', reverse: false },
  { id: 102, text: { en: 'Often forget to put things back in their proper place.', de: 'Vergesse oft, Dinge an ihren Platz zurückzulegen.', ca: "Sovint m'oblido de tornar les coses al seu lloc.", 'es-MX': 'A menudo olvido poner las cosas en su lugar.', 'fr-CA': "J'oublie souvent de remettre les choses à leur place.", da: 'Glemmer tit at sætte tingene på plads igen.' }, domain: 'discipline', facet: 'structure', reverse: true  },
  ...
  { id: 104, text: { en: 'Leave my belongings around.', de: 'Lasse meine Sachen herumliegen.', ca: 'Deixo les meves coses escampades.', 'es-MX': 'Dejo mis pertenecías regadas.', 'fr-CA': 'Je laisse traîner mes choses.', da: 'Efterlader mine ting rundt omkring.' }, domain: 'discipline', facet: 'structure', reverse: true  },
  // Oath (Dutifulness) — c3
  ...
  { id: 108, text: { en: 'Break my promises.', de: 'Breche meine Versprechen.', ca: 'Trenco les meves promeses.', 'es-MX': 'Rompo mis promesas.', 'fr-CA': 'Je ne tiens pas mes promesses.', da: 'Bryder mine løfter.' }, domain: 'discipline', facet: 'oath', reverse: true  },
  // Quest (Achievement-Striving) — c4
  { id: 109, text: { en: "Do more than what's expected of me.", de: 'Tue mehr, als von mir erwartet wird.', ca: "Faig més del que s'espera de mi.", 'es-MX': 'Hago más de lo que se espera de mi.', 'fr-CA': "Je fais plus que ce que l'on attend de moi.", da: 'Gør mere, end hvad der forventes af mig.' }, domain: 'discipline', facet: 'quest', reverse: false },
  ...
  { id: 112, text: { en: 'Do just enough work to get by.', de: 'Arbeite gerade so viel, dass es reicht.', ca: 'Faig només la feina justa per sortir del pas.', 'es-MX': 'Hago el trabajo mínimo para salir adelante.', 'fr-CA': "Je fais juste assez de travail pour m'en sortir.", da: 'Arbejder kun så meget, at jeg lige kan klare mig.' }, domain: 'discipline', facet: 'quest', reverse: true  },
  // Will (Self-Discipline) — c5
  { id: 113, text: { en: 'Am always prepared.', de: 'Bin immer vorbereitet.', ca: 'Sempre estic preparat/da.', 'es-MX': 'Siempre estoy preparado.', 'fr-CA': 'Je suis toujours préparé.', 'fr-FR': 'Je suis toujours préparé·e.', da: 'Er altid velforberedt.' }, domain: 'discipline', facet: 'will', reverse: false },
  { id: 114, text: { en: 'Carry out my plans.', de: 'Setze meine Pläne um.', ca: 'Duc a terme els meus plans.', 'es-MX': 'Llevo a cabo mis planes.', 'fr-CA': 'Je réalise mes objectifs.', da: 'Fører mine planer ud i livet.' }, domain: 'discipline', facet: 'will', reverse: false },
  ...
  { id: 117, text: { en: 'Jump into things without thinking.', de: 'Lasse mich auf Dinge ein, ohne nachzudenken.', ca: 'Em fico en les coses sense pensar-hi.', 'es-MX': 'Me aviento a hacer cosas sin pensar.', 'fr-CA': 'Je me lance dans les choses sans réfléchir.', da: 'Springer ud i ting uden at tænke mig om.' }, domain: 'discipline', facet: 'counsel', reverse: true  },
  { id: 118, text: { en: 'Make rash decisions.', 'es-MX': 'Tomo decisiones precipitadas.', de: 'Treffe voreilige Entscheidungen.', ca: 'Prenc decisions precipitades.', 'fr-CA': 'Je prends des décisions impulsives.', da: 'Tager forhastede beslutninger.' }, domain: 'discipline', facet: 'counsel', reverse: true  },
